...
export function Cta() {
  return (
    <section className="px-6 py-20">
      <div className="mx-auto max-w-4xl rounded-3xl border border-primary-500/20 bg-linear-to-br from-primary-900/60 to-background-secondary p-10 text-center md:p-16">
